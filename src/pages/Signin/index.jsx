    ...
    return(
      <form ref={form} className="flex flex-col gap-4 w-80">
        <div className="flex flex-col gap-1">
          <label htmlFor="name" className="font-light text-sm"> Yout name:</label>
          <input 
          type="text"
          id="name"
          name="name" 
        ...
        <div className="flex flex-col gap-1">
          ...
          placeholder="hi@correoDePrueba.com"
          className="rounded-lg border border-black
          placeholder:font-light placeholder:text-sm placeholder:text-black/60 focus:outline-none py-2 scroll-px-4"/>
        </div>
        <div className="flex flex-col gap-1">
